...
See [12a_Secret_Safe_APIs.md](12a_Secret_Safe_APIs.md) for the complete secret values API reference, and [12_API_Migration_Guide.md](12_API_Migration_Guide.md) for migration patterns and examples.
