...
| *(row retracted — `GetVersatilityBonus` is NOT removed)* | — | — | See [retraction](#getversatilitybonus-retraction). Function remains alive in live retail source; "double-counting" claim was unverified. |
