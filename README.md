...
This comprehensive knowledge base contains **everything** you need to create, debug, analyze, and maintain World of Warcraft addons. Originally created by analyzing the complete WoW 11.2.7 (The War Within) UI source code, now updated for **12.0.1 (Midnight)** with documentation of the major API changes including the "Addon Apocalypse" Secret Values system.
